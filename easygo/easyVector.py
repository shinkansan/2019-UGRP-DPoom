...
desired_Angle = 45 # for init working
...
def main(speed=1, desiredAngle):
    rate = rospy.Rate(5000) #Change if reaction time is slow
    Kp = 1.7375 / 45
